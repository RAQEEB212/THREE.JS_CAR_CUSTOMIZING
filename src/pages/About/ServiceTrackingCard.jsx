...
export default function ServiceTrackingCard() {
  return (
    <div className='rounded-3xl bg-black py-10 px-5 flex flex-row items-end justify-evenly'>


        {/* Modified car number */}
      <div className='text-white flex flex-col items-center gap-y-5'>
<h1 className='font-extrabold text-5xl'>6,500,00</h1>
...
<h1 className='font-extrabold text-5xl'>+1,000</h1>
...
<h1 className='font-extrabold text-5xl'>+20,000</h1>
